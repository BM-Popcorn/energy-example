...
This folder defines all source code for the 'turbine_data_sdp' pipeline:
...
* Take a look at the sample under "sample_users_turbine_data_sdp.py" to get familiar with the syntax.
